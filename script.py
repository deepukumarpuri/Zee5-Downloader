...
Currently I'm in beta mode 🥺, If found any bugs, @HK_ROBOT_HELP
...
NOTE: Download may take some time! So please wait for it to complete!"""
    ...
    ABOUT_TEXT = """⭕️<b>My Name : HK ROBOT Zee5 DL</b>

⭕️<b>Creater :</b> @HK_ROBOT_HELP
...
"""    
    ...
    UPGRADE_TEXT = "PING at @HK_ROBOT_HELP"
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "**Thank you for Using Meh!! ❤️ Join @HK_ROBOT_HELP **"
